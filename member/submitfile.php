...
$na=$_SESSION['tname'];
$gn=$_SESSION['gname'];
$sql1="select * from memberfile where nsender='$na'";
...
if(isset($_GET['dele'])){
 ...
 if(isset($_POST['submi'])){
      ...
      if(move_uploaded_file($tname, "../memberfile/".$name))//the function is used to move the file to the folder
        { 
          $discri=$_POST['pinfo'];
          $date1=date("y/m/d");
          $sql="insert into memberfile(id,pname,cdate,pinformation,nsender,groupname,path) values('','$name','$date1','$discri','$na','$gn','../memberfile/$name') ";
   ...
   <body>
     ...
     <div class="row">
           <div class="col-lg-4">
               ...
               <form style="padding-left: 10px;" action="submitfile.php" method="post" enctype="multipart/form-data">
                   <b>project file</b>
               ...
               <table class="table table-bordered">
                 ...
                 <?php while($row=mysqli_fetch_assoc($result)) {?>
                  <tr>
                    ...
                    <td> <a href="submitfile.php?dele=<?php echo $row['id']?>" class="btn btn-danger"><span class="  glyphicon glyphicon-trash"></span></a></td>
